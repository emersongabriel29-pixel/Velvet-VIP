...
test('private playback uses edge authorization and short signed URL',()=>{assert.match(card,/getPlayableVideoUrl/);assert.match(signed,/createSignedUrl\(path, 120\)/);assert.match(signed,/age_verified/);});
