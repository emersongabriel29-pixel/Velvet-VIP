...
const INITIAL_TAGS: SystemTag[] = [
  { id: 'tag-1', name: 'velvetvip', slug: 'velvetvip', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-2', name: 'exclusivo', slug: 'exclusivo', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-3', name: 'bastidores', slug: 'bastidores', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-4', name: 'ensaio', slug: 'ensaio', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-5', name: 'glamour', slug: 'glamour', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-6', name: 'fitness', slug: 'fitness', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-7', name: 'performance', slug: 'performance', is_active: true, created_at: new Date().toISOString() },
  { id: 'tag-8', name: 'sensual', slug: 'sensual', is_active: true, created_at: new Date().toISOString() },
];

const INITIAL_SECURITY_LOGS: SecurityAuditLog[] = [
  { id: 'sec-1', event: 'Verificação de Idade 18+', user_email: 'fernandaaraujodasilva17@gmail.com', ip_address: '177.136.21.94', status: 'success', details: 'Termos aceitos e idade legal confirmada.', timestamp: new Date(Date.now() - 3600000).toISOString() },
  { id: 'sec-2', event: 'Login Seguro TLS 1.3', user_email: 'fernandaaraujodasilva17@gmail.com', ip_address: '177.136.21.94', status: 'success', details: 'Sessão iniciada com token seguro.', timestamp: new Date(Date.now() - 3500000).toISOString() },
  { id: 'sec-3', event: 'Auditoria LGPD & RLS', user_email: 'admin@velvetvip.com', ip_address: '127.0.0.1', status: 'success', details: 'Políticas de privacidade e RLS auditadas.', timestamp: new Date(Date.now() - 86400000).toISOString() },
];
...
const INITIAL_USERS: User[] = [
  {
    id: 'user-001',
    email: 'fernandaaraujodasilva17@gmail.com',
